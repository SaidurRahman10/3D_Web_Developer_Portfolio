...
const Navbar = () => {
  ...
  return (
    <nav
      className={`${styles.paddingX} w-full flex item-center py-5 fixed top-0 z-20  bg-gradient-to-r from-blue-400 via-cyan-600 to-pink-400 bg-opacity-60 shadow-2xl`}
    >
